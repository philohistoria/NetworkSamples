...
- In the first plot, $disp(U,H)$=1: there is only one pair whose $d$ is 1: $(A,E)$.
      - all other pairs, such as $(C,F)$ have common friend $D$ who is also $U$'s friend; $(F,E)$ are directly linked.
- In the second plot, $disp(U,H)$=4: there are four pairs whose $d$ is 1: $(F,K)$,$(F,J)$,$(C,J)$,$(C,K)$.
